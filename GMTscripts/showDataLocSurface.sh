gmt begin ../GMTfigs/MarsDataLocSurface
...
gradlow=../GMTdata/topogradlores.grd
gmt grdsample ${topograd} -G${gradlow} -R${R} -I${res}
gmt grdimage $gradlow -C -Ra -JG200/-69/25/7c
# Plot data dots on top
gmt makecpt -Cvik -T${colrng} -Z 
gmt plot ../GMTdata/synth_MarsNew_surface_noise10pc_gmtloc.txt -Sc${dotsize} -Rg -C -Bxa30g30 -Bya10g10 -BNSEW
...
dotsize=${ds}
gmt makecpt -Cgray -T-1.5/1/0.1 -Z
gmt grdimage $gradlow -C -Ra -JG200/-69/25/7c -X7.5c
gmt makecpt -Cvik -T${colrng} -Z 
gmt plot ../GMTdata/synth_MarsNew_surface_noise10pc_sub30_gmtloc.txt -Sc${dotsize} -Rg -C -Bxa30g30 -Bya10g10 -BNSEW -W0.01p,black
gmt text -R0/1/0/1 -Jx7c --FONT=20 <<EOF
0.05 0.95 b
EOF
gmt text -R0/1/0/1 -Jx7c --FONT=13 <<EOF
...
gmt grdimage $gradlow -C -Ra -JG200/-69/25/7c -X7.5c
gmt makecpt -Cvik -T${colrng} -Z 
gmt plot ../GMTdata/synth_MarsNew_surface_noise10pc_sub10_gmtloc.txt -Sc${dotsize} -Rg -C -Bxa30g30 -Bya10g10 -BNSEW -W0.01p,black
gmt text -R0/1/0/1 -Jx7c --FONT=20 <<EOF
0.05 0.95 c
EOF
gmt text -R0/1/0/1 -Jx7c --FONT=13 <<EOF
...
### Colorbar
gmt colorbar -X-14c -Y-1c -Dx0c/0c+w20c/0.3c+h+e --FONT=13 -B2150+l"radial component at data altitude [nT]"
