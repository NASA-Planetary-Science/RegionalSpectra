gmt begin ../GMTfigs/MarsResultSurface_noise10p pdf
...
maxval=121
##### Selecting J
gmt basemap -JX9c/4c -R720/925/${minval}/${maxval} -Bnews 
for i in {1..100}
do
    gmt plot ../GMTdata/examples/manyrmse_MarsNew${str}/rmse${i}.txt -Wgray
done
gmt plot ../GMTdata/examples/manyrmse_MarsNew${str}/mean_rmse.txt -Wthick,black -Bxa25 -Bya1 -BneSW -Bx+l"number @[J@[ of Slepian functions" -By+l"rmse [nT]"
...
diffhi=../GMTdata/Lang_minus_synthMarsNew${str2}_mean_hi_res.grd
