gmt begin ../GMTfigs/MarsResultSurfaceAbbrv_noise10p pdf
...
topograddiff=../GMTdata/MarsTopo16ppd_gradient_diff.grd
...
#diffhi=../GMTdata/synthMarsNew${str2}_diff_hi.grd
#gmt grdsample ${CMdiff} -G${diffhi} -R${R} -I0.1

#gmt grdgradient ${topomod} -G${topograddiff}  -R${R} -A270/0/90 -Ne0.5
