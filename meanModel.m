function meanModel(planet,altnr,addstrdata,addstrsav)
  ...
  switch altnr
    case 1
      load(['manysynth_',planet,addstrdata,'.mat']);
    case 2
      load(['manysynth_',planet,addstrdata,'_alt.mat']);
    case 3
      load(['manysynth_',planet,addstrdata,'_alt2.mat']);
  end
  ...
  switch altnr
    case 1
      filename = ['synth',planet,addstrsav,'_meanmodel.mat'];
    case 2
      filename = ['synth',planet,addstrsav,'_meanmodel_alt.mat'];
    case 3
      filename = ['synth',planet,addstrsav,'_meanmodel_alt2.mat'];
  end
